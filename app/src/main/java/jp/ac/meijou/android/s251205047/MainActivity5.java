...
import jp.ac.meijou.android.s251205047.databinding.ActivityMain4Binding;
import jp.ac.meijou.android.s251205047.databinding.ActivityMain5Binding;
import okhttp3.Call;
...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonText.setOnClickListener(view ->{
            var text = binding.text.getText().toString();
